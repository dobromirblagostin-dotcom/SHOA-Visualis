...
## Структура
- [poems/](poems) — стихи по отдельным файлам. Один стих = один файл.
- [tags/](tags) — теги-ключи для быстрого поиска по концепциям SHOA (`shoa-tags.json`).
- [cantus/](cantus) — заготовки для песен и мантр (короткие строки, повторы, припевы).
- [posts/](posts) — изображения для публикаций в соцсетях.
- [emblems/](emblems) — эмблемы и логотипы.
